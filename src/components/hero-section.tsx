...
const SOCIALS = [
  ...
  { href: DATA.contact.social.whatsapp.url, icon: MessageCircle, label: "WhatsApp" },
...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* ── Main content ── */}
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-8 flex flex-col items-center gap-10 pt-28 pb-20">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
            ...
            >
              <a
                ...
                style={{
                  ...
                  boxShadow: "0 0 35px rgba(124,58,237,0.6), 0 4px 20px rgba(0,0,0,0.35)",
                  position: "relative",
                  overflow: "hidden",
              ...
              >
                ...
                />
                <ArrowDownToLine className="size-4 relative" style={{ zIndex: 1 }} />
          ...
          >
            {/* Outer pulsing aura */}
            <div aria-hidden className="hero-aura-1 absolute inset-0 rounded-full" />
            <div aria-hidden className="hero-aura-2 absolute inset-0 rounded-full" />
        ...
        >
          {STATS.map(({ value, label, icon }, i) => (
            ...
            >
              ...
              />
              <span className="text-2xl mb-1" style={{ lineHeight: 1 }}>{icon}</span>
              <span style={{
                fontSize: "1.9rem",
                fontWeight: 900,
              ...
              <span style={{ fontSize: "0.72rem", color: "var(--muted-foreground)", textAlign: "center", lineHeight: 1.3, marginTop: "2px" }}>{label}</span>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          {["React", "Next.js", "Node.js", "TypeScript", "Python", "Docker", "PostgreSQL", "NestJS"].map((s) => (
            <span key={s} className="hero-skill-pill">{s}</span>
          ))}
          <span className="hero-skill-pill hero-skill-pill-more">+{DATA.skills.length - 8} more</span>
        </motion.div>
      </div>
      ...
      >
        <span className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground/60">Scroll</span>
      ...
      <style jsx>{`
        ...
        @keyframes orb-drift-1 { from { transform: translate(0,0) scale(1); } to { transform: translate(40px, 30px) scale(1.08); } }
        @keyframes orb-drift-2 { from { transform: translate(0,0) scale(1); } to { transform: translate(-30px, -20px) scale(1.05); } }
        @keyframes orb-drift-3 { from { opacity: 0.5; } to { opacity: 1; } }
        ...
        .hero-name-accent {
          background: linear-gradient(120deg, #a78bfa 0%, #818cf8 35%, #60a5fa 65%, #c084fc 100%);
        ...
        .hero-cta-primary {
          ...
          color: white;
          background: linear-gradient(135deg, #7c3aed 0%, #4f46e5 50%, #2563eb 100%);
          box-shadow: 0 0 30px rgba(124,58,237,0.55), 0 4px 20px rgba(0,0,0,0.3);
          overflow: hidden;
          transition: transform 0.2s, box-shadow 0.2s;
        }
        .hero-cta-primary:hover {
          transform: translateY(-2px);
          box-shadow: 0 0 50px rgba(124,58,237,0.75), 0 8px 30px rgba(0,0,0,0.4);
        }
        ...
        @keyframes ring-reverse { from { transform: rotate(0deg); } to { transform: rotate(-360deg); } }
        .hero-ring-spin { animation: ring-spin 20s linear infinite; }
        .hero-ring-spin-reverse { animation: ring-reverse 30s linear infinite; }
