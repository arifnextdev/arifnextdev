...
export const DATA = {
  ...
  location: "Anuhala, Tangail, Bangladesh",
  locationLink: "https://www.google.com/maps/place/sanfrancisco",
  description:
    "Full Stack Developer turned problem-solver. I love creating impactful solutions and supporting others along the way. Always exploring new ideas and staying engaged with the community.",
  summary:
    "Full Stack Developer with experience in building and maintaining high-performance applications. He focuses on developing scalable solutions and has worked on integrating frontend components with backend services. Known for his strong code structure and quick learning ability, he stays up to date with the latest technologies to ensure optimal project outcomes.",
  avatarUrl: "/arif.jpg",
  skills: [
    "React",
    "Vue",
  ...
  work: [
    {
      ...
      description:
        "As a Full Stack Developer at Thoughtbridge, I develop and maintain scalable web applications, ensuring smooth user experiences and optimized backend functionality. I collaborate with cross-functional teams to deliver high-performance solutions, while prioritizing code quality, security, and efficiency.",
    },
    {
      company: "Mathmozo It",
      badges: [],
      ...
      description:
        "As a Junior Web Developer at Mathmozo IT, I built and maintained React components, ensuring seamless integration with backend services to deliver responsive and efficient web applications.",
    },
  ],
  education: [
    {
    ...
    {
      school: "Bagbari Chowbariya High School",
  ...
  projects: [
    {
      title: "Thirsty Server",
      href: "https://thirsty-server.vercel.app/",
      ...
      links: [
        {
          type: "Website",
          href: "https://github.com/arifnextdev/thirsty-server",
